...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Yo Malkinn,<br /><br /> I have subconsciously always added you in my prayers, and I wish this year brings the best to you to show you how highly I think of you, Heer <br /><br />Rajib</p>
    </div>
