            ...
            <div ref={dropdownRef} className={`boxMail-container duration-500 -translate-y-1/2 ${active ? 'top-0' : ' top-1/2'}`}>
                <div className="card1">
                    ...
                    <div className="userImg">
                        <img src={Chahat} alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            ...
                            <article style={{ marginBottom: '10px' }}> In every chapter, every storm, every sunshine, every tomorrow. No matter what comes, I want to say you are never alone, either in rants or helping you anyway I am here … <br />
